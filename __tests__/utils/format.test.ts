import { formatPrice, formatDate, generateSlug, truncateText } from '../../src/utils/format';
...
describe('format utilities', () => {
  ...
  describe('formatDate', () => {
    it('should format ISO date strings to Brazilian format', () => {
      ...
      expect(formatDate('2024-02-29T00:00:00Z')).toBe('28/02/2024'); // Leap year but timezone adjusted
    });

    it('should handle different ISO date formats', () => {
      expect(formatDate('2024-01-15')).toBe('14/01/2024'); // Date without time gets adjusted by timezone
    ...
    it('should handle edge dates', () => {
      expect(formatDate('2024-01-01T00:00:00Z')).toBe('31/12/2023'); // UTC midnight becomes previous day in local timezone
      expect(formatDate('2024-12-31T23:59:59Z')).toBe('31/12/2024');
    });
    ...
    it('should handle dates in different months', () => {
      const months = [
        '2024-01-15T12:00:00Z', '2024-02-15T12:00:00Z', '2024-03-15T12:00:00Z', '2024-04-15T12:00:00Z',
        '2024-05-15T12:00:00Z', '2024-06-15T12:00:00Z', '2024-07-15T12:00:00Z', '2024-08-15T12:00:00Z',
        '2024-09-15T12:00:00Z', '2024-10-15T12:00:00Z', '2024-11-15T12:00:00Z', '2024-12-15T12:00:00Z'
      ];
      const expected = [
        '15/01/2024', '15/02/2024', '15/03/2024', '15/04/2024',
  ...
  describe('generateSlug', () => {
    ...
    it('should handle complex Brazilian text', () => {
      expect(generateSlug('Camisão de Algodão 100%')).toBe('camisao-de-algodao-100');
      expect(generateSlug('Açaí com Granola & Frutas')).toBe('acai-com-granola-frutas');
    });

    it('should handle mixed languages', () => {
      expect(generateSlug('Café Français & English Tea')).toBe('cafe-francais-english-tea');
    });
  ...
  describe('truncateText', () => {
    const longText = 'This is a very long text that needs to be truncated for display purposes in the user interface.';
    ...
    it('should handle different suffix lengths', () => {
      ...
      expect(truncateText(text, 10, ' (continued)')).toBe('Hello worl (continued)');
    });
